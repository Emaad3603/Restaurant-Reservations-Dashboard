        ...
        <div class="card-body">
            <form action="{{ route('admin.meal-types.update', $mealType) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('label') is-invalid @enderror" id="label" name="label" value="{{ old('label', $mealType->label) }}" required>
                    @error('label')
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('company_id') is-invalid @enderror" id="company_id" name="company_id" value="{{ old('company_id', $mealType->company_id) }}">
                    @error('company_id')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
